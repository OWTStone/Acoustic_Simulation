...
yData = []
saved_model_name = 'best_model_441000_epochs500_batch64_32_16_8_sigmoid_freq_presplit.keras'
...
for file in res:
  ...
  while (startCount + Ntemp) < Nsamples[0]: # verify sufficient number of samples exist
    ...
    T = 1.0/sample_rate
    if channel_type == "mono":
      yf = fft(samples[startCount:startCount+Ntemp],n=N)
    else:
      yf = fft(samples[startCount:startCount+Ntemp,0],n=N)
